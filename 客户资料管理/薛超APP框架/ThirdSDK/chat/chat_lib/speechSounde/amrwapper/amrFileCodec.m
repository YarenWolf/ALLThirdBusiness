...
NSData* EncodePCMToAMR(char* data, int maxLen,int nChannels, int nBitsPerSample)
{
   ...
   // [defaults setValue:self.userName forKey:K_alreadyNum];
    ...
    NSString *wavFile        = [[documentPath stringByAppendingPathComponent:@"SpeechSoundDir"] stringByAppendingPathComponent:[NSString stringWithFormat:@"alreadyEncoderData%@.amr",[defaults valueForKey:K_alreadyNum]]];
