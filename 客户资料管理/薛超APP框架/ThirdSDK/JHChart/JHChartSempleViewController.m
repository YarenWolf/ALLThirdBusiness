//
//  JHChartSempleViewController.m
//  薛超APP框架
//
//  Created by 薛超 on 16/11/14.
//  Copyright © 2016年 薛超. All rights reserved.
#import "JHChartSempleViewController.h"
#import "JHChartHeader.h"
@implementation JHChartSempleViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    switch (_index) {
        case 0:[self showFirstQuardrant];break;
        case 1:[self showFirstAndSecondQuardrant];break;
        case 2:[self showFirstAndFouthQuardrant];break;
        case 3:[self showAllQuardrant];break;
        case 4:[self showPieChartUpView];break;
        case 5:[self showRingChartView];break;
        case 6:[self showColumnView];break;
        case 7:[self showTableView];break;
        case 8:[self showRadarChartView];break;
        default:break;
    }
}
//第一象限折线图
- (void)showFirstQuardrant{
    JHLineChart *lineChart = [[JHLineChart alloc] initWithFrame:CGRectMake(10, 100, APPW-20, 300) andLineChartType:JHChartLineValueNotForEveryX];
...
- (void)showRingChartView{
    /*创建对象*/
    JHRingChart *ring = [[JHRingChart alloc] initWithFrame:CGRectMake(0, 100, APPW, APPW)];
    /*背景颜色*/
 ...
 */
- (void)showTableView{
    JHTableChart *table = [[JHTableChart alloc] initWithFrame:CGRectMake(10, 64, APPW-20, APPH)];
    /*表名称*/
    ...
    table.frame = CGRectMake(10, 64, APPW-20, [table heightFromThisDataSource]);
}

- (void)showRadarChartView{
    JHRadarChart *radarChart = [[JHRadarChart alloc] initWithFrame:CGRectMake(10, 74, APPW - 20, APPW - 20)];
