...
#define APP_ID          @"wxa195a30bd338dd17"               //APPID
#define APP_SECRET      @"fd2218539a4c684f8be2305124962f9e" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1243153902"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"zxj35052119741004105013701886128"
//支付结果回调页面
