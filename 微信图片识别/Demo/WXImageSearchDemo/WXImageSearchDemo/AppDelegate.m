...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UINavigationController *nc = [[[UINavigationController alloc] initWithRootViewController:[[[WXImageSearchViewController alloc] init] autorelease]] autorelease];
    ...
    //self.window.rootViewController = [[[WXImageSearchViewController alloc] init] autorelease];
    return YES;
}
