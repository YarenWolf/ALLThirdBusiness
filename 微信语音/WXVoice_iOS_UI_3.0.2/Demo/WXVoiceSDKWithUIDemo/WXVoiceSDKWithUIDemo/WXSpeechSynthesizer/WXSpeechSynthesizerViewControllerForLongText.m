...
- (BOOL)startWithText:(NSString *)text{
    [_ssView addTestStr:[NSString stringWithFormat:@"size=%d",(int)text.length]];
...
- (void)errorCode:(NSInteger)errorCode{
    [_ssView reSetView];
    [WXErrorMsg showErrorMsg:[NSString stringWithFormat:@"错误码：%d",(int)errorCode] onView:self.view];
}
